...
SELECT * FROM (SELECT 'check_sc' AS `job_name`, '/var/www/cron/controller.py' AS `script`, 1 AS `enabled`, 0 AS `log_it`, '60' AS time, '' AS `output`, '0000-00-00 00:00:00' AS `datetime`) AS tmp
WHERE NOT EXISTS (
